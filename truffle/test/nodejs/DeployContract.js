...
var sensorId = "Hello World!";
var price = web3.toWei(10, "ether");

web3.eth.contract(contractABI).new({from: web3.eth.coinbase, data: contractByteCode, gas: 3000000}, function (err, contract) {
        if (!err && contract.address) {
            console.log("deployed on:", contract.address);
            var contract = web3.eth.contract(contractABI).at(contract.address);
